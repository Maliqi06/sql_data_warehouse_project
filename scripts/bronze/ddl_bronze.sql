...
IF OBJECT_ID('bronze.source_customer_product', 'U') IS NOT NULL
    DROP TABLE bronze.source_customer_product;
GO

CREATE TABLE bronze.source_customer_product (
    product_id                  INT,
